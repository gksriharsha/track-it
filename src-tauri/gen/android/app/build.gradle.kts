...
android {
    ...
    defaultConfig {
        ...
        applicationId = "com.kgundu1.trackit"
        minSdk = 24
        targetSdk = 36
    ...
    buildTypes {
        ...
        getByName("release") {
            ...
            // models themselves stay because scanning must work offline, but
            // unrelated resources do not ride along in the release APK.
...
dependencies {
    ...
    // Android-only, bundled models: the first scan works offline and on devices
    // without Google Play Services. Only the Latin OCR model is included because
    // the shared nutrition parsers currently understand Latin-script labels.
